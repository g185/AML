...
$\frac{\partial J}{\partial z_{i}^{(3)}} = - \frac{1}{N} (\psi (z_{j}^{(i)}) - \bigtriangleup_i$ \\ \\

$z_{i}^{(3)} = a_{i}^{(3)} W^2 + b^2$ \\ \\

$\frac {\partial J}{\partial W_2} = \frac {1}{N} (\psi (z_{ji} - \bigtriangleup_i) a_{2i} $ \\ \\

$\frac {\partial J}{\partial a_{2i}} = \frac{1}{N} (\psi (z_{ij} - \bigtriangleup_i) W_2$ \\	\\

$\frac {\partial J}{\partial b} = \frac {\partial J}{\partial z_{ji}} = \frac{1}{N} (\psi(z_{jn}) - \bigtriangleup_i)$ \\ \\

$\frac {\partial J}{\partial z_{2i}} = \frac {\partial J}{\partial a_{2i}} \frac {\partial J_{2i}}{\partial z_{2i}} \rightarrow a_{2i}\left\{\begin{array}{ll}
0, & \text { if } z_{2i}<0 \\
z_{2i}, & \text { if } z_{2i}\geq0
\end{array}\right.
\rightarrow \frac {\partial a_{2i}}{\partial z_{2i}} =
\left\{\begin{array}{ll}
0, & \text { if } z_{2i}<0 \\
i, & \text { if } z_{2i}\geq0
\end{array}\right.
...
$\frac {\partial J}{\partial z_{2i}} = \frac{1}{N} (\psi(z_{2i}) - \bigtriangleup_i) \delta_i$ \\ \\

$\frac {\partial J}{\partial b_i} = \frac {\partial J}{\partial z_{2i}}$ \\ \\

$\frac {\partial J}{\partial W_1} = \frac {\partial J}{\partial z_{2i}} a_{i}^{(i)} \ \ \  \|\frac {\partial J}{\partial a_i} = \frac {\partial J}{\partial z_{2i}}$
